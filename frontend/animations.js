...
// <section data-gsap="parallax-bg" data-gsap-speed="-0.5">
//   <img class="parallax-image" src="bg.jpg">
// </section>
//
...
// - parallax-bg (parallax for background images, apply to container with .parallax-image child)
//
// Optional attributes:
...
// - data-gsap-speed="-0.5" (parallax-bg: -1 to 1, negative=opposite direction)
