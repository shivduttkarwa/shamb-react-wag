...
class SlideItemBlock(blocks.StructBlock):
    ...
    date = blocks.DateBlock(
        required=False,
        help_text="Publication date (for news/blog slides)"
    )
    category = blocks.CharBlock(
        max_length=100,
        required=False,
        help_text="Category or tag"
    )
    featured = blocks.BooleanBlock(
        required=False,
        default=False,
        help_text="Mark as featured slide"
    )
...
class NewsSlideBlock(SlideItemBlock):
    """News-specific slide with additional fields."""
    excerpt = blocks.TextBlock(
        required=False,
        help_text="News excerpt"
    )
...
class BlogSlideBlock(SlideItemBlock):
    """Blog-specific slide with additional fields."""
    excerpt = blocks.TextBlock(
        required=False,
        help_text="Blog excerpt"
    )
